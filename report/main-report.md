...
- Required intentional-failure run: [GitHub Actions #32505900553](https://github.com/Jiduckiess/HW06/actions/runs/32505900553), commit `1998d99`, conclusion **failure**. It changed only A1-001's expected status from `200` to `201`; [GitHub Actions #32506035480](https://github.com/Jiduckiess/HW06/actions/runs/32506035480), commit `473fd8f`, restores the correct oracle and concludes **success**. Screenshot: `<save red intentional-failure screenshot under evidence/ci/>`.
